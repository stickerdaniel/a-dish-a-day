...
This folder contains default calendar files (.ddcal) that will be automatically imported when the app is launched for the first time.

To add a default calendar:
