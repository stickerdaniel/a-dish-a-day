  ...
  var body: some View {
    Form {
      ...
      Section(
        ...
        footer: Text(
          "If enabled, the calendar's start date will be set to the import date. The end date and all recipe unlock dates will be adjusted accordingly."
        )
      ) {
    ...
    .toolbar {
      ToolbarItem(placement: .topBarTrailing) {
        ...
        .disabled(
          editingCalendar.name.isEmpty || editingCalendar.startDate > editingCalendar.endDate)
      }
    }
